...
import dev.radom.constructmanage.app.construction.client.repository.ClientMapper;
import dev.radom.constructmanage.app.construction.client.model.Client;
import dev.radom.constructmanage.app.construction.client.repository.ClientRepository;
...
public class ClientServiceImpl implements ClientService {
    ...
    public void addNewClient(AddNewClientDto addNewClientDto) {
        ...
        client.setCode("CL-" + RandomCode.generateCode());
