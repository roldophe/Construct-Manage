...
import dev.radom.constructmanage.app.construction.job.repository.JobRepository;
...
import dev.radom.constructmanage.app.user.Authority;
import dev.radom.constructmanage.app.user.AuthorityRepository;
import dev.radom.constructmanage.app.user.RoleRepository;
...
//        roleRepository.saveAll(List.of(adminRole, userRole));
    ...
    private void createAndSaveJob(String description, Float chargeHour) {
        Job job = new Job();
        job.setCode("JOB-" + RandomCode.generateCode());
